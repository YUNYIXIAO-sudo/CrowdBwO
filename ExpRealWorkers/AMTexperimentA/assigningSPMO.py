...
qualification = '37RMV253MFRHR06HDGMWORYIFC7L82'
...
while np.any(PullingisFeasible == 1) == 1:
    ...
    if reward[0] >= para.targetAnswers and PullingisFeasible[0] == 1:
        stopHIT(hitid1)
        PullingisFeasible[0] = 0
    if reward[1] >= para.targetAnswers and PullingisFeasible[1] == 1:
        stopHIT(hitid2)
