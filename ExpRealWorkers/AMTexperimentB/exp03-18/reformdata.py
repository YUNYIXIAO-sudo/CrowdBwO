...
results = pd.read_csv('./exp03-18/AssignmentResults19.csv')


ans = np.array(results['answer1'])
...
for i in range(1, time[-1]+1):
    ...
    if correctAnswers[0] >= 30 and PullingisFeasible[0] == 1:
        finalRewards[0] = correctAnswers[0]
        finalPulls[0] = collectedAnswers[0]
    elif correctAnswers[0] >= 30 and PullingisFeasible[0] == 0:
        correctAnswers[0] = finalRewards[0]
        collectedAnswers[0] = finalPulls[0]


    if correctAnswers[1] >= 30 and PullingisFeasible[1] == 1: 
        finalRewards[1] = correctAnswers[1]
        finalPulls[1] = collectedAnswers[1]
    elif correctAnswers[1] >= 30 and PullingisFeasible[1] == 0: 
        correctAnswers[1] = finalRewards[1]
        collectedAnswers[1] = finalPulls[1]
    ...
    if correctAnswers[0] >= 30:
        PullingisFeasible[0] = 0

    if correctAnswers[1] >= 30: 
...
df.to_csv('./exp03-18/realEXPresultsSPMO18.csv', mode='w')